                ...
                <form onSubmit={handleSubmit} className="space-y-6" noValidate>
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        autoComplete="name"
                        className="w-full px-4 py-3 bg-white/5 border border-white/20 rounded-[2rem] text-white placeholder-white/40 focus:outline-none focus:border-gold-500 transition-colors"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        required
                        className="w-full px-4 py-3 bg-white/5 border border-white/20 rounded-[2rem] text-white focus:outline-none focus:border-gold-500 transition-colors"
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 bg-white/5 border border-white/20 rounded-[2rem] text-white placeholder-white/40 focus:outline-none focus:border-gold-500 transition-colors resize-none"
                    />
                  </div>
                  ...
                  <button
                    ...
                    className="w-full btn-primary rounded-[2rem] flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {isSubmitting ? (
                      <>
